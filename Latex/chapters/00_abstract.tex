...
Decentralised multi-robot task allocation (MRTA) methods such as
...
161$\times$63 with 200 agents) against three baselines: CBBA, the centralised
Sequential Greedy Algorithm~(SGA), and the state-of-the-art decentralised
...
\textbf{[PLACEHOLDER: 1.0--1.X]} relative to SGA, within the theoretical
$\frac{1}{2}$-optimality bound inherited from GCBBA.
...
The results establish LCBA as the most robust decentralised allocation
